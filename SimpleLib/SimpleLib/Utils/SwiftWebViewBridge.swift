...
///实现UIWebViews通过JS与Swift之间发送消息
@available(iOS, introduced: 2.0, deprecated: 12.0, message: "WKWebView自带Bridge机制")
...
extension SwiftWebViewBridge {
     ...
     */
    public func sendDataToJS(_ data: AnyObject) {
     ...
     */
    public func sendDataToJS(_ data: AnyObject, responseCallback: SWVBResponseCallBack?) {
     ...
     */
    public func callJSHandler(_ handlerName: String?, params: AnyObject?, responseCallback: SWVBResponseCallBack?) {
