...
extension ExpandingTableViewController {
    ...
    func getScreen() -> UIImage? {
        ...
        return view.takeSnapshot(frame: CGRect(origin: backImageOrigin, size: backImageSize))
    }
...
extension ExpandingTableViewController {
    ...
    public func popTransitionAnimation() {
        ...
        transitionDriver.popTransitionAnimationContantOffset(offset: offset, backImage: backImage)
