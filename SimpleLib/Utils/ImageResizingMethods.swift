...
/**
 ...
 - returns: scaledImage
 */
func imageResizeUIKit(_ imageURL: URL, scalingFactor: Double) -> UIImage? {
...
func imageResizeCoreGraphics(_ imageURL: URL, scalingFactor: Double) -> UIImage? {
...
private func _imageResizeCoreImage(_ context: CIContext, imageURL: URL, scalingFactor: Double) -> UIImage? {
...
func imageResizeCoreImageGPU(_ imageURL: URL, scalingFactor: Double) -> UIImage? {
...
func imageResizeCoreImageSoftware(_ imageURL: URL, scalingFactor: Double) -> UIImage? {
...
func imageResizeVImage(_ imageURL: URL, scalingFactor: Double) -> UIImage? {
    ...
    defer {
        sourceBuffer.data.deallocateCapacity(Int(sourceBuffer.height) * Int(sourceBuffer.height) * 4)
    }
